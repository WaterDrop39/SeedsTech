...
public class ExtractOnlyItemHandlerWrap implements IItemHandlerModifiable
{
	protected final IItemHandlerModifiable handle;
	public ExtractOnlyItemHandlerWrap(IItemHandlerModifiable handle)
	{
		this.handle = handle;
	}
	/**
